...
public static class ServiceCollectionExtensions
{
    ...
    internal class FuncCertificateFetcherAdapter : ICertificateFetcher
    {
        private readonly Func<CancellationToken, Task<ICollection<PemCertificateInfo>>> _fetcher;

        public FuncCertificateFetcherAdapter(Func<CancellationToken, Task<ICollection<PemCertificateInfo>>> fetcher)
        {
            _fetcher = fetcher;
        }
