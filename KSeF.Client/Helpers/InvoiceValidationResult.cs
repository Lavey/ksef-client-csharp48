...
public class XmlValidationResult : ValidationResult
{
    ...
    /// </summary>
    public XDocument InvoiceXDocument { get; }

    public XmlValidationResult(bool isValid, string message, XDocument invoiceXDocument)
        : base(isValid, message)
    {
        InvoiceXDocument = invoiceXDocument;
    }
}
}
